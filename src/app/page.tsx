          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 animate-in fade-in slide-in-from-left-8 duration-700">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4">
                ...
                <Link href="/home" className="flex items-center gap-2 px-6 py-3 border border-secondary text-text-primary font-bold rounded-md hover:bg-surface-alt transition-all">
                  <div className="w-10 h-10 rounded-full bg-surface-alt flex items-center justify-center">
                    <Play className="w-4 h-4 fill-secondary text-text-primary" />
                  </div>
            ...
            <div className="relative animate-in fade-in slide-in-from-right-8 duration-700 delay-200">
              ...
              <div className="relative z-10 rounded-3xl overflow-hidden aspect-square group shadow-3xl border border-border bg-surface p-3">
              ...
              <div className="absolute -top-10 -left-10 z-20 bg-surface/90 backdrop-blur-xl p-5 rounded-2xl shadow-elevated border border-primary/10 animate-bounce-subtle">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                    <Sparkles className="w-6 h-6 text-primary" />
                  </div>
                  <div>
                    <div className="text-[10px] font-black text-text-secondary uppercase tracking-widest mb-0.5">Taxonomic Match</div>
                    <div className="flex items-center gap-2">
                       <div className="text-3xl font-black font-serif text-text-primary">98%</div>
                ...
                <div className="flex items-center gap-4">
                  <div className="relative">
                    ...
                    <div className="absolute -bottom-1 -right-1 w-4 h-4 rounded-full bg-emerald-500 border-2 border-secondary flex items-center justify-center">
                      <div className="w-1.5 h-1.5 rounded-full bg-surface animate-pulse" />
                    </div>
                  </div>
                  <div>
      ...
      <section id="features" className="py-24 bg-surface border-t border-border">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group bg-surface p-10 border border-border rounded-2xl hover:-translate-y-2 hover:shadow-elevated transition-all duration-300">
              ...
              <h3 className="text-xl font-bold mb-4 font-serif text-text-primary">Intelligent Matchmaking</h3>
            ...
            <div className="group bg-surface p-10 border border-border rounded-2xl hover:-translate-y-2 hover:shadow-elevated transition-all duration-300">
              ...
              <h3 className="text-xl font-bold mb-4 font-serif text-text-primary">Problem Boards</h3>
              <p className="text-text-secondary leading-relaxed">
            ...
            <div className="group bg-surface p-10 border border-border rounded-2xl hover:-translate-y-2 hover:shadow-elevated transition-all duration-300">
              ...
              <h3 className="text-xl font-bold mb-4 font-serif text-text-primary">Unified Funding</h3>
              <p className="text-text-secondary leading-relaxed">
      ...
      <section id="institutions" className="py-32 bg-secondary text-white relative overflow-hidden">
         ...
         <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
           ...
           <div className="relative animate-in fade-in slide-in-from-right-8 duration-700">
             <div className="w-full aspect-[4/3] bg-surface/5 border border-white/10 rounded-2xl overflow-hidden shadow-2xl backdrop-blur-sm p-4 relative group">
                <img 
                ...
                <div className="absolute inset-0 flex items-center justify-center p-8">
                  <div className="w-full h-full bg-surface-alt backdrop-blur-md rounded-xl border border-white/10 shadow-3xl overflow-hidden flex flex-col">
                    <div className="p-4 border-b border-white/10 flex justify-between items-center bg-surface/5">
                    ...
                    <div className="flex-1 p-6 flex gap-6 overflow-hidden">
                       ...
                       <div className="flex-1 space-y-2 opacity-80">
                         <div className="h-4 w-32 bg-surface/10 rounded mb-4" />
                         <div className="grid grid-cols-12 gap-1.5">
                            {[...Array(48)].map((_, i) => (
                              <div key={i} className={`aspect-square rounded-sm ${i % 7 === 0 ? 'bg-primary' : i % 5 === 0 ? 'bg-primary/40' : 'bg-surface/5'}`} />
                            ))}
                         </div>
                       </div>
                       {/* Mock Chat Sidebar */}
                       <div className="w-48 bg-surface/5 rounded-lg p-4 border border-white/5 hidden md:block">
                          <div className="space-y-4">
                             <div className="flex gap-2">
                               <div className="w-6 h-6 rounded-full bg-surface/10 shrink-0" />
                               <div className="space-y-1">
                                 <div className="h-1.5 w-16 bg-surface/20 rounded" />
                                 <div className="h-1.5 w-24 bg-surface/10 rounded" />
                               </div>
                             </div>
