...
const PublicProfile: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-12 pt-6 pb-12 animate-in fade-in duration-500">
      ...
      <Link 
        href="/matching" 
        className="group flex items-center gap-2 text-sm font-bold text-text-secondary hover:text-text-primary transition-all mb-8"
      >
        <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
        Back to Matching Hub
      </Link>

      <section className="relative bg-surface border border-border rounded-t-[40px] overflow-hidden shadow-soft mb-12">
          ...
          <div className="flex-1 pt-24 space-y-6">
            <div className="flex flex-col xl:flex-row justify-between items-start gap-8">
              ...
              <div className="flex gap-3 w-full sm:w-auto">
                ...
                <button className="flex-1 sm:flex-none border border-border text-text-primary px-8 py-2.5 rounded-md font-bold text-sm hover:bg-surface-alt transition-all flex items-center justify-center gap-2 active:scale-95">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-8 space-y-16">
          ...
          <section>
            <div className="border-b border-border pb-4 mb-8">
              <h2 className="text-xl font-black font-serif tracking-tight text-text-primary">Public Research & Contributions</h2>
            </div>

            <div className="space-y-6">
              {managedContent.map(item => (
                <div key={item.id} className="bg-surface border border-border p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 rounded-3xl hover:shadow-soft transition-all group">
                  ...
                  <div className="shrink-0">
                    <button className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest border border-border text-text-secondary px-5 py-2.5 rounded-xl hover:bg-surface-alt hover:text-text-primary transition-all">
        ...
        <aside className="lg:col-span-4 space-y-12 lg:pl-12 lg:border-l border-border">
            ...
            <div className="space-y-4">
              <div className="p-5 bg-surface border border-border rounded-2xl shadow-sm group hover:border-border transition-all">
                <div className="flex justify-between items-center">
                  ...
                  <div className="w-10 h-10 bg-surface-alt rounded-xl flex items-center justify-center text-text-secondary">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 bg-surface border border-border rounded-2xl shadow-sm">
